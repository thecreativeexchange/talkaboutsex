...
MtMatrix3 MtMatrix3::CrossProductMatrix(MtVector3 &v)
{
	// Set the martix to zero
	MtMatrix3 m;
...
void MtMatrix3::SetRotationXYZ( MtVector3& angles )
{
	BtFloat a = cos( angles.x );
	BtFloat b = sin( angles.x );
   
	BtFloat c = cos( angles.y );
	BtFloat d = sin( angles.y );

	BtFloat e = cos( angles.z );
	BtFloat f = sin( angles.z );

    _00 = c*e;         _01 = -c*f;        _02 = d;
	_10 = a*f + b*d*e; _11 = a*e - b*d*f; _12 = -b*c;
	_20 = b*f - a*d*e; _22 = a*d*f + b*e; _22 = a*c;
}
...
MtMatrix3& MtMatrix3::operator+=(MtMatrix3 &m)
{
	_00 += m._00;
	_01 += m._01;
	_02 += m._02;
