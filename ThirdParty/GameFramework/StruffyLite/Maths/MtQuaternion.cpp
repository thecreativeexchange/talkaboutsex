...
MtQuaternion::MtQuaternion(BtFloat yaw, BtFloat pitch, BtFloat roll)
{
    // yaw, pitch and roll are defined in radians
	BtFloat c1 = (BtFloat) cos(yaw/2);
	BtFloat s1 = (BtFloat) sin(yaw/2);
	BtFloat c2 = (BtFloat) cos(pitch/2);
	BtFloat s2 = (BtFloat) sin(pitch/2);
	BtFloat c3 = (BtFloat) cos(roll/2);
	BtFloat s3 = (BtFloat) sin(roll/2);
    BtFloat c1c2 = c1*c2;
	BtFloat s1s2 = s1*s2;
...
MtQuaternion MtQuaternion::SLerp( BtFloat t, MtQuaternion& From, MtQuaternion& To )
{
	...
	return MtQuaternion( From * Scale0 ) + MtQuaternion( To1 * Scale1 );
}
