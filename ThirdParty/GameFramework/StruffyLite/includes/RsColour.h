...
public:
    ...
    void										Red( BtFloat red );
    void										Green( BtFloat green );
    void										Blue( BtFloat blue );
...
inline void RsColour::Red( BtFloat red )
{
    m_red = red;
}
...
inline void RsColour::Green( BtFloat green )
{
    m_green = green;
}
...
inline void RsColour::Blue( BtFloat blue )
{
    m_blue = blue;
}
